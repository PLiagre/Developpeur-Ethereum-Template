...
contract VotingCyril is Ownable {
    ...
    /** @notice 
        ...
        Winning proposalID is calculated everytime new vote is set
    */
    ...
    /** @notice 
        Checks if the workflow status is OK and change the workflow status
